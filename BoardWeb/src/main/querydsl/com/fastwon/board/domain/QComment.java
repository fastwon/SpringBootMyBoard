...
public class QComment extends EntityPathBase<Comment> {
    ...
    private static final long serialVersionUID = 1055489822L;
    ...
    public final DateTimePath<java.util.Date> cmtCreateDate = createDateTime("cmtCreateDate", java.util.Date.class);
